...
//
		...
		if (authentication != null && authentication.getPrincipal() instanceof MberVOWrapper) {
	        ...
	        if (mber != null) { //회원일때
	            ...
	            String realcstNo = realMber.getCstNo();
	            
	            CstmrVO cstmr = service.retrieveCstmrAge(realcstNo);
	            String age = cstmr.getAge();
	            
	            Map<String, Object> customerData = new HashMap<>();
	            customerData.put("age", age);
	            customerData.put("totalNmpr", nbrCnt);
...
//		
	...
	public String rcRmList(
		String adult, String child, Model model
	) {
