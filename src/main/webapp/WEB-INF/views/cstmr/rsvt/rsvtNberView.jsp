...
function cancelPay() {
	if(confirm("정말 예약취소를 하시겠습니까?")==true){

	var formData = new FormData();
	formData.append("setleMerchantUid",'${setleVO.setleMerchantUid}')
	formData.append("refndAmnt",'${setleVO.setleAmnt}')
	formData.append("reason","예약취소")
	formData.append("cstNo",'${nberRsvtList.cstNo}')
	var data={
