			...
			<div class="col-lg-4">
				<div class="card h-75">
					<div class="card-header">
						<h5 class="mb-0 go-btn">출퇴근</h5><div class="time"><h6 style="text-align:right" class="go-btn">현재시각:</h6><h6 style="text-align:right" class="go-btn" id="now"></h6></div>
					</div>
...
<!--               <button id="capture" class="btn btn-info" onclick="captureAndSend()">사진촬영</button> -->
				<br><a class="btn btn-link btn-sm btn p-0" href="javascript:captureAndSend()" >얼굴 캡처 하기</a>
            </div>
...
<!--       </div> -->
      <div class="modal-footer">
        ...
        <button class="btn btn-primary" type="button" onclick="checkDclz()">출퇴근등록</button>
							...
							<a class="btn btn-link btn-sm btn p-0" href="<c:url value='/emp/pbl/dclz/yryc'/>">휴가 신청하러가기<span
							class="fas fa-chevron-right ms-1 fs--2"></span></a>
							<button class="btn btn-link btn-sm btn p-0 go-btn" type="button"
								data-bs-toggle="modal" data-bs-target="#commute-inquiry-modal">출퇴근 문의 요청 남기기<span
