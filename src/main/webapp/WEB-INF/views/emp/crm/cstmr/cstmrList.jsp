    ...
    <div class="col-auto col-sm-5 mb-3">
      ...
      <div class="input-group">
        <select class="form-select form-select-sm mb-3" aria-label="Bulk actions" data-list-filter="data-list-filter">
          ...
          <option value="BBLUE">BBLUE</option>
          <option value="LBLUE">LBLUE</option>
          <option value="DBLUE">DBLUE</option>
          <option value="BGREEN">BGREEN</option>
          ...
          <option value="BBLACK">BBLACK</option>
          <option value="LBLACK">LBLACK</option>
          <option value="DBLACK">DBLACK</option>
        </select>
      </div>
    </div>
  </div>
    ...
    <table class="table table-bordered table-striped fs-10 mb-0">
      <thead class="bg-200">
        <tr>
          ...
          <th class="text-900 sort" data-sort="cstNm">Name</th>
