<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <script src="${pageContext.request.contextPath}/resources/vendors/typed.js/typed.js"></script>
    ...
    <script src="${pageContext.request.contextPath}/resources/js/app/cstmr/layout/jquery.fullpage.min.js"></script>
