...
import kr.or.ddit.mybatis.mappers.EmpStayListMapper;
...
public class EmpPmsStayListServiceImpl implements EmpPmsStayListService {

	private final EmpStayListMapper dao;
