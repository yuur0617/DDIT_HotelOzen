    ...
    <div class="container recom-table text-center mb-5">
        <ul class="nav nav-tabs" id="myTab" role="tablist">
		 ...
		 <div class="tab-content p-3" id="myTabContent">
		    <!-- 객실/예약 -->
		    <div class="tab-pane fade active" id="tab-roomReserContent" role="tabpanel" aria-labelledby="tab-roomReser">
		                    ...
		                    <c:if test="${faq.faqCt eq '객실/예약'}">
		                        <div class="accordion-item">
		                            <h2 class="accordion-header">
		                                <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseRoomReser${faq.faqNo}" aria-expanded="true" aria-controls="collapseRoomReser${faq.faqNo}">
		                                    ${faq.faqNm }
		                                </button>
		                            </h2>
		            ...
		            <div class="accordion" id="accordionBudeExample">
		                <c:forEach items="${faqList}" var="faq">
		                    <c:if test="${faq.faqCt eq '부대시설'}">
		                        <div class="accordion-item">
		                            <h2 class="accordion-header">
		                                <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseBude${faq.faqNo}" aria-expanded="true" aria-controls="collapseBude${faq.faqNo}">
		                                    ${faq.faqNm }
		                                </button>
		                            </h2>
		            ...
		            <div class="accordion" id="accordionMbshipExample">
		                <c:forEach items="${faqList}" var="faq">
		                    <c:if test="${faq.faqCt eq '멤버십/계정'}">
		                        <div class="accordion-item">
		                            <h2 class="accordion-header">
		                                <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseMbship${faq.faqNo}" aria-expanded="true" aria-controls="collapseMbship${faq.faqNo}">
		                                    ${faq.faqNm }
		                                </button>
		                            </h2>
		            ...
		            <div class="accordion" id="accordionOtherExample">
		                <c:forEach items="${faqList}" var="faq">
		                    <c:if test="${faq.faqCt eq '기타'}">
		                        <div class="accordion-item">
		                            <h2 class="accordion-header">
		                                <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOther${faq.faqNo}" aria-expanded="true" aria-controls="collapseOther${faq.faqNo}">
		                                    ${faq.faqNm }
		                                </button>
		                            </h2>
