			...
			<div class="row flex-between-end">
				...
				<div class="row g-0 px-5 py-5">
					<div class="col-lg-7 pe-lg-2">
						<div class="card-body">
							<c:forEach var="i" begin="0" end="${rsvtDtlList.size()-1 }" >
								<button class="btn btn-outline-secondary me-1 mb-1 rsvtDtlLink" type="button">${rsvtDtlList[i].rsvtDtlNo}</button>
							</c:forEach>
							
							<form:form method="post" modelAttribute="newChkin" id="walkInForm" action="/hotelOzen/emp/pms/stay/chkin.do">
								<div class="col-sm-5 mb-4">
									<label class="form-label" for="rsvtDtl-no">예약번호</label>
									<input class="form-control" id="rsvtDtl-no" type="text" name="rsvtDtlNo"
										placeholder="Reservation number" value=""/>
								</div>
								...
								<div class="row gx-2">
									...
									<div class="col-sm-3 mb-3">
										...
										<input class="form-control datetimepicker" id="cstmr-hp" name="cstmr.cstHp"
											type="text" placeholder="phone" value=""/>
									</div>
									<div class="col-sm-3 mb-3">
									...
									<div class="col-sm-3 mb-3">
										...
										<input class="form-control datetimepicker" id="cstmr-carKind" name="ciCarKind"
									...
									<div class="col-sm-4 mb-3">
										...
										<input class="form-control" id="total-cnt" type="text" name="ciTotalNmpr"
									...
									<div class="col-sm-4">
										...
										<input class="form-control datetimepicker" id="room-type" name="room.rmtTypeCd"
											type="text" placeholder="room Type" value="" readonly/>
									</div>
									<div class="col-sm-4">
									...
									<div class="col-sm-4">
										...
										<input class="form-control datetimepicker" id="room-price" name="setle.setleAmnt"
											type="text" placeholder="price" value="" readonly/>
									</div>
								</div>
								<input type="hidden" id="cstmrNo" name="cstmr.cstNo" value=""/>
								<div class="py-5">
									<div class="float-end">
							...
							<input type="hidden" id="rmtTypehidden" value=""/>
							<input type="hidden" id="adultCnthidden" value=""/>
							<input type="hidden" id="childCnthidden" value=""/>
							<input type="hidden" id="rsvtAmnthidden" value=""/>
						</div>
					</div>
...
<script src="<c:url value='/resources/js/app/emp/pms/rsvt/qrRsvtList.js'/>"></script>