...
<!-- ===============================================-->
    ...
    <link href="${pageContext.request.contextPath}/resources/assets/css/font.css" rel="stylesheet">
    <link href="${pageContext.request.contextPath}/resources/css/common/jquery.fullpage.min.css" rel="stylesheet">
...
<script type="text/javascript" src="${pageContext.request.contextPath }/resources/js/app/common/telnumberUtil.js"></script>
